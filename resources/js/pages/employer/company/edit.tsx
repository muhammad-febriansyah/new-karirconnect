...
import { BadgeCheck, Loader2, MapPin, Plus, Save, Trash2 } from 'lucide-react';
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Section title="Branding">
                        <div className="grid gap-5 md:grid-cols-2">
                            <ImageUploadField
                                label="Logo"
                                description="Format PNG/JPG, max 1MB"
                            ...
                            <ImageUploadField
                                label="Cover"
                                description="Banner halaman perusahaan, max 2MB"
                    ...
                    >
                        <div className="space-y-4">
                            {form.data.offices.map((office, index) => {
                                ...
                                return (
                                    <div key={office.id ?? `new-${index}`} className="rounded-lg border p-4">
                    ...
                    <Section title="Budaya">
                        <TextareaField
                            ...
                            onChange={(e) => form.setData('culture', e.target.value)}
